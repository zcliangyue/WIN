...
class EDSRLiDAR(nn.Module):
    def __init__(self, n_resblocks=16, n_feats=64, res_scale=1, conv=ConvLiDAR, use_range=True, use_xyz=False):
        ...
        # print('range:'+ str(use_range) +';xyz:'+ str(use_xyz))
        # print('input_depth='+str(self.input_depth))
        # define head module
        m_head = [conv(self.input_depth, n_feats, kernel_size)]
